...
const Hero = () => {
    return (
        <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-white">
            <div className="absolute top-0 right-0 w-1/3 h-full bg-violet-50/50 skew-x-12 transform origin-top-right z-0" />
            ...
            <div className="grid max-w-7xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 relative z-10">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    >
                        ...
                        <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-slate-900">
                            ...
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-purple-500">Intelligent AI</span>
                        </h1>
                        <p className="max-w-2xl mb-6 font-light text-slate-600 lg:mb-8 md:text-lg lg:text-xl">
                            Summarize PDFs, generate quizzes, create flashcards, and use the Pomodoro Timer. Join thousands of students boosting their grades with StudyBuddy.
                        </p>
                        <Link to="/dashboard" className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-center text-white bg-violet-500 rounded-lg hover:bg-violet-600 focus:ring-4 focus:ring-violet-300 transition-all hover:scale-105 shadow-lg shadow-violet-500/20">
                            Start Learning Free
                ...
                <div className="hidden lg:mt-0 lg:col-span-5 lg:flex relative">
                    ...
                    >
                        <div className="absolute top-10 right-10 w-64 h-64 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob" />
                        <div className="absolute -bottom-8 -left-8 w-64 h-64 bg-violet-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000" />
                        ...
                        <div className="relative glass-panel p-6 rounded-2xl border border-white bg-white/60 backdrop-blur-xl shadow-2xl skew-y-1 transform hover:skew-y-0 transition-transform duration-500">
                            <div className="space-y-4">
                                <div className="flex items-center space-x-4 p-4 bg-white rounded-xl shadow-sm border border-slate-100">
                                    <div className="p-3 bg-violet-100 rounded-lg"><Sparkles className="w-6 h-6 text-violet-600" /></div>
                                    <div>
                                ...
                                <div className="flex items-center space-x-4 p-4 bg-white rounded-xl shadow-sm border border-slate-100">
                                    <div className="p-3 bg-purple-100 rounded-lg"><Zap className="w-6 h-6 text-purple-600" /></div>
                                    <div>
                                        <h4 className="font-bold text-slate-800">Quiz Generated</h4>
                                        <p className="text-xs text-slate-500">10 Questions • Hard Difficulty</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-4 p-4 bg-white rounded-xl shadow-sm border border-slate-100">
                                    <div className="p-3 bg-violet-100 rounded-lg"><Brain className="w-6 h-6 text-violet-600" /></div>
                                    <div>
