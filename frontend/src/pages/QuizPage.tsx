    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8">
                ...
                <div className="glass-panel p-6 rounded-2xl bg-white border border-slate-200">
                    <form onSubmit={handleGenerate} className="flex gap-4">
                        <input
                            ...
                            className="flex-1 bg-white border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-yellow-500/50 shadow-sm placeholder-slate-400"
                        />
                        <button type="submit" disabled={!topic} className="btn-primary from-yellow-500 to-amber-500">
                            Generate
                        </button>
                    </form>
                </div>
            ...
            {quiz && !showResult && !loading && (
                <div className="glass-card p-8 rounded-2xl border-yellow-200 bg-white">
                    <div className="mb-6 flex justify-between items-center text-sm text-slate-500">
                        <span>Question {currentQuestion + 1} of {quiz.questions.length}</span>
                        <span className="text-yellow-600 font-medium">{quiz.title}</span>
                    </div>
                    ...
                    {isAnswered && (
                        <div className="mt-8 flex justify-end">
                            <button onClick={nextQuestion} className="btn-primary from-yellow-500 to-amber-500">
            ...
            {showResult && (
                ...
                >
                    ...
                    <div className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-amber-600 mb-8">
