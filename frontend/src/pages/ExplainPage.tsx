        ...
        <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="glass-panel p-6 rounded-2xl bg-white border border-slate-200">
                <form onSubmit={handleExplain} className="flex gap-4 flex-col md:flex-row">
                    <input
                        ...
                        className="flex-1 bg-white border border-slate-200 rounded-xl px-4 py-3 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-violet-500/50 transition-all shadow-sm"
                    />
                    <button
                        type="submit"
                        disabled={loading || !topic}
                        className="btn-primary flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed from-violet-500 to-purple-500"
                    >
            ...
            {explanation && (
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="glass-card p-8 rounded-2xl border-violet-200 shadow-xl shadow-violet-500/5 bg-white"
                >
