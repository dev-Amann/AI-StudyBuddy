            ...
            <div className="glass-panel p-6 rounded-2xl bg-white border border-slate-200">
                <form onSubmit={handleGenerate} className="flex gap-4">
                    <input
                        ...
                        className="flex-1 bg-white border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:outline-none focus:ring-2 focus:ring-violet-500/50 shadow-sm placeholder-slate-400"
                    />
                    <button type="submit" disabled={loading || !topic} className="btn-primary from-violet-500 to-purple-500">
                    ...
                    <div className="w-full max-w-lg aspect-[3/2] perspective-1000">
                        ...
                        >
                            ...
                            <div className="absolute w-full h-full backface-hidden bg-white border-2 border-slate-200 rounded-3xl flex flex-col items-center justify-center p-8 text-center shadow-2xl shadow-slate-200">
                                <span className="text-violet-500 text-sm font-bold uppercase tracking-wider mb-4">Term</span>
                            ...
                            {/* Back */}
                            <div
                                className="absolute w-full h-full backface-hidden bg-violet-50 border-2 border-violet-200 rounded-3xl flex flex-col items-center justify-center p-8 text-center shadow-2xl backdrop-blur-xl"
                                style={{ transform: "rotateY(180deg)" }}
                            >
                                <span className="text-violet-600 text-sm font-bold uppercase tracking-wider mb-4">Definition</span>
